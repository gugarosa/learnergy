...
# Creating a ConvRBM
model = ConvRBM(visible_shape=(v_shape, v_shape), filter_shape=(f_shape, f_shape), n_filters=n_filters,
                n_channels=n_channels, learning_rate=0.01, momentum=0, decay=0, use_gpu=True)
