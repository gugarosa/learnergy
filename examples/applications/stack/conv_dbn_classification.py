...
from learnergy.models.stack import ConvDBN
...
model = ConvDBN(visible_shape=(v_shape, v_shape), filter_shape=f_shape,
             n_filters=n_filters, n_channels=n_channels, learning_rate=(0.00001, 0.00001), momentum=(0.9, 0.9), decay=(0., 0.), use_gpu=True)
...
# except:
    # Training a CDBN
model.fit(train, batch_size=batch_size, epochs=(1, 1))
