...
model = GaussianConvRBM(visible_shape=(v_shape, v_shape), filter_shape=(f_shape, f_shape), n_filters=n_filters,
                        n_channels=n_channels, learning_rate=0.00001, momentum=0.5, decay=0, use_gpu=True)
